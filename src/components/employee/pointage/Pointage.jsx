...
function Pointage() {
  ...
  async function fetcha(values) {
    ...
    dates = d;
    let URL =
      "http://localhost:9000/getpointage?userId=" +
    ...
    let days = results.pointage.map(function (a) {
      return a.day;
    });
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          {7 * index + 1 <= numberOfDays ? (
                            <th>{7 * index + 1}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 2 <= numberOfDays ? (
                            <th>{7 * index + 2}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 3 <= numberOfDays ? (
                            <th>{7 * index + 3}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 4 <= numberOfDays ? (
                            <th>{7 * index + 4}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 5 <= numberOfDays ? (
                            <th>{7 * index + 5}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 6 <= numberOfDays ? (
                            <th>{7 * index + 6}</th>
                          ) : (
                            <span></span>
                          )}
                          {7 * index + 7 <= numberOfDays ? (
                            <th>{7 * index + 7}</th>
                          ) : (
                            <span></span>
                          )}
