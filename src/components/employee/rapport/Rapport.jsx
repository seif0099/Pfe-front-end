...
function Rapport() {
  ...
  async function reqRapport(values) {
    let result = await fetch(
      "http://localhost:9000/requestRapport?id=" +
        userInfo._id,
      {
        method: "POST",
        headers: {
  ...
  function validate(values) {
    ...
    if (!values.dateAcc) {
      errors.dateAcc =
        "* Le champ date accident est obligatoire";
    }
    if (!values.condition) {
      errors.condition =
        "* Le champ condition est obligatoire";
    }
    if (!values.place) {
      errors.place =
        "* Le champ place accident est obligatoire";
    }
    if (values.place == " ") {
      errors.place =
        "* Le champ place accident est obligatoire";
          ...
          <form action="submit">
            ...
            <div className="form-row last">
              ...
              <div className="form-wrapper">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="Place de l'accident"
                  name="place"
                  onChange={handleChange}
                />
                <i className="zmdi zmdi-chevron-down"></i>
            ...
            <div className="form-wrapper">
              ...
              <input
                type="text"
                className="form-control"
                placeholder="Condition de l'accident"
                name="condition"
                onChange={handleChange}
              />
              <i className="zmdi zmdi-chevron-down"></i>
