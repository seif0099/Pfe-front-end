      ...
      <div className="wrapper wrapper4">
        <div className="inner inner4">
          <form action="submit">
            ...
            {touched.userid && errors.userid ? <p className="errors">{errors.userid}</p> : null}

            <div className="form-row">
              <div className="form-wrapper">
                <label htmlFor="">Nature de sanction *</label>
                <input type="text" className="form-control" placeholder="Raison" name="reasonForSanction" onChange={handleChange} />
              </div>
            </div>
            {touched.reasonForSanction && errors.reasonForSanction ? <p className="errors">{errors.reasonForSanction}</p> : null}
